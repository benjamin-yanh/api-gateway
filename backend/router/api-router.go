...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/login", middleware.PasswordLoginRateLimit(), middleware.DisableCache(), anonymousRequestBodyLimit, middleware.TurnstileCheck(), controller.Login)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/redemption-card/history", middleware.DisableCache(), controller.GetRecentRedemptionCardHistory)
		...
		usageRoute.Use(middleware.ControlPlaneCORS(), middleware.CriticalRateLimit())
		{
		...
		accessLogRoute := apiRouter.Group("/access-log")
		accessLogRoute.Use(middleware.AdminAuth(), middleware.DisableCache())
		{
			accessLogRoute.GET("/", controller.GetAccessLogs)
			accessLogRoute.GET("/:id", controller.GetAccessLog)
		}
		...
		logRoute.Use(middleware.ControlPlaneCORS(), middleware.CriticalRateLimit())
		{
