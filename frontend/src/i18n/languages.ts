 ...
 * but `supportedLngs`/resources use the non-standard camelCase code. All
 * Chinese variants intentionally use the Simplified Chinese resource.
 */
...
/**
 * Convert an interface language code (the value i18next uses, `zhCN`) into a
 * valid BCP-47 locale tag that the `Intl.*` APIs accept.
 *
