...
describe('API key group table cell', () => {
  ...
  test('renders an unclipped localized Auto ratio alongside the cross-group badge', async () => {
  ...
  test('keeps the Auto ratio visible without animation for reduced motion', async () => {
    const container = document.createElement('div')
    document.body.append(container)
    const root = createRoot(container)
  ...
  test('keeps the cross-group label visible without a ratio or animation when ratio data is unavailable', async () => {
    const container = document.createElement('div')
    document.body.append(container)
    const root = createRoot(container)
