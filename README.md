...
<p align="center">
  <a href="https://www.cherry-ai.com/" target="_blank">
    <img src="./backend/docs/images/cherry-studio.png" alt="Cherry Studio" height="80" />
  </a><!--
  --><a href="https://github.com/iOfficeAI/AionUi/" target="_blank">
    <img src="./backend/docs/images/aionui.png" alt="Aion UI" height="80" />
  </a><!--
  --><a href="https://bda.pku.edu.cn/" target="_blank">
    <img src="./backend/docs/images/pku.png" alt="北京大学" height="80" />
  </a><!--
  --><a href="https://www.compshare.cn/?ytag=GPU_yy_gh_newapi" target="_blank">
    <img src="./backend/docs/images/ucloud.png" alt="UCloud 优刻得" height="80" />
  </a><!--
  --><a href="https://www.aliyun.com/" target="_blank">
    <img src="./backend/docs/images/aliyun.png" alt="阿里云" height="80" />
  </a>
</p>
...
```text
frontend/  React 前端与 Electron 桌面壳
backend/   Go API、转发服务、部署配置与后端文档
```
...
# 前端（默认代理 API 到 http://localhost:3000）
cd frontend
bun install
bun run dev
```

生产环境可分别部署两个服务，由前端站点的反向代理把 `/api` 等请求转发到后端，并通过后端的 `FRONTEND_BASE_URL` 指定前端地址。需要兼容原来的单体二进制时，可运行 `make build-embedded`。
...
📖 [图文教程](./backend/docs/installation/BT.md)
...
Token、Origin 校验和 PAT 契约见[用户鉴权与登录会话](./backend/docs/authentication.md)。
