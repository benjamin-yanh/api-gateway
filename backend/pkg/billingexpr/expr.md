...
**File**: `frontend/src/pages/Setting/Ratio/components/TieredPricingEditor.jsx`
...
**Files**: `service/log_info_generate.go`, `frontend/src/helpers/render.jsx`
...
| Frontend editor | `frontend/src/pages/Setting/Ratio/components/TieredPricingEditor.jsx` |
| Frontend display | `frontend/src/helpers/render.jsx`, `frontend/src/helpers/utils.jsx` |
| Model detail | `frontend/src/components/table/model-pricing/modal/components/DynamicPricingBreakdown.jsx` |
| Log display | `frontend/src/hooks/usage-logs/useUsageLogsData.jsx`, `frontend/src/components/table/usage-logs/UsageLogsColumnDefs.jsx` |
