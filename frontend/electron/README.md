...
- Store database in `backend/data/new-api.db`

## Building for Production

### Quick Build
```bash
# From frontend/electron/, build the frontend, Go binary, and desktop package
./build.sh
...
### Build Output
- Built applications are in `frontend/electron/dist/`
...
### Database Location
- **Development**: `backend/data/new-api.db` (project directory)
- **Production**:
